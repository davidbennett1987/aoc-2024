...
def main():
    ...
    day04input = read_file("input/day04/input.txt")
    day04 = Day04(day04input)
    logger.info(f"Day 04, part 1 answer is: {day04.part1_solution()}")
    logger.info(f"Day 04, part 2 answer is: {day04.part2_solution()}")
